...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) { 
        ...
        if (enemy.health <= 0) {
            ...
            // awaard player money for winning
            playerInfo.money = playerInfo.money + 20;
            //leave while()loop since enemy is dear
            break;
        } else {
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // pick a new enemy to right based on the index of the enemy.names array
...
var getPlayerName = function() {  //<-- there is a glitch here, check against code-->
    var name ="";
